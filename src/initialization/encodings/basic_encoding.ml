...
let commands = [
  ...
  ("\025", "FSIX");   (* f6 (Catalog) *)
  ("\026", "THICKA"); (* Thick A (hidden) *)
  ("\027", "THICKB"); (* Thick B (hidden) *)
  ("\028", "THICKC"); (* Thick C (hidden) *)
  ("\029", "THICKD"); (* Thick D (hidden) *)
  ("\030", "THICKE"); (* Thick E (hidden) *)
  ("\031", "THICKF"); (* Thick F (hidden) *)
  ...
  ("\164", "SMALLO"); (* Small o (hidden) *)
  ("\165", "EPOWER"); (* e^ *)
  ("\166", "INT");    (* Int (Optn > Num) *)
  ("\167", "HIDDENNOT"); (* Not (hidden) *)
  ("\168", "POWER");  (* ^ *)
  ("\169", "TIMES");  (* Multiplication sign *)
  ("\170", "LOWERCASEOR"); (* or (hidden) *)
  ...
  ("\214", "BIN");    (* Bin (hidden) *)
  ("\215", "OCT");    (* Oct (hidden) *)
  ("\216", "WHITERECT");    (* White rectangle (hidden) *)
  ...
  (* \255: empty character (0 pixel wide) *)
  ...
  ("\127\101", "IPERCENT"); (* I(percent) (Catalog) *)
  ...
  ("\247\027", "LINEARREGAPLUSBX"); (* LinearReg(a+bx) (Catalog) *)
  ...
  ("\247\066", "LINEARREGAXPLUSB"); (* LinearReg(ax+b) (Catalog) *)
  ...
  ("\247\203", "RSELON"); (* R SelOn (Menu > Recr > Sel+S) *)
  ...
  ("\247\219", "RSELOFF"); (* R SelOff (Menu > Recr > Sel+S) *)
  ...
  ("\249\187", "PERIODSANNUAL"); (* PeriodAnnual (Catalog) *)
  ("\249\188", "PERIODSSEMI"); (* PeriodSemi (Catalog) *)
